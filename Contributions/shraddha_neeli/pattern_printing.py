...
n24 = int(input("enter a odd number for letter X : "))
...
for row in range(n18):
    for col in range(n18):
        if (row == 0 or row == n18 // 2) and (col < n18 - 1):
            print("* ", end="")
...
for row in range(n16):
    for col in range(n16):
        if (row == 0 or row == n16 // 2) and (col < n16 - 1):
            print("* ", end="")
        elif (col == 0 or (col == n16 - 1 and 0 < row <= n16 // 2 - 1)):
            print("*", end=" ")
        else:
            print(" ", end=" ")
    print()
...
for row in range(n5):
    for col in range(n5):
        if col == 0 or (row == 0 or row == n5 // 2 or row == n5 - 1):
            print("*", end=" ")
        else:
            print(" ", end=" ")
    print()
...
for row in range(n4):
    for col in range(n4):
        if col == 0 or (col == n4 - 1 and 0 < row < n4 - 1) or ((row == 0 or row == n4 - 1) and (0 < col < n4 - 1)):
            print("*", end=" ")
        else:
            print(" ", end=" ")
    print()
...
for row in range(n3):
    for col in range(n3):
        if (col == 0 and 0 < row < n3 - 1) or ((row == 0 or row == n3 - 1) and col > 0):
            print("*", end=" ")
        else:
            print(" ", end=" ")
    print()
...
for row in range(n2):
    for col in range(n2):
        if (col == 0 and 0 < row < n2 - 1) or (col == n2 - 1 and 0 < row < n2 - 1 and row != n2 // 2) or (row == 0 and col < n2 -1) or (row == n2 - 1 and col < n2 -1) or (row == n2 // 2 and col < n2 - 1):
            print("*", end=" ")
        else:
            print(" ", end=" ")
    print()
